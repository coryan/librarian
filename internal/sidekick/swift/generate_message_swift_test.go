...
func TestGenerateMessage_WithNestedMessages(t *testing.T) {
	...
	nested1 := api.NewTestMessage("Nested1").
		...
		WithID(".google.cloud.test.v1.WithNested.Nested1")
	nested2 := api.NewTestMessage("Nested2").
		WithPackage("google.cloud.test.v1").
		WithID(".google.cloud.test.v1.WithNested.Nested2")
	withNested := api.NewTestMessage("WithNested").
		WithPackage("google.cloud.test.v1")
	withNested.Messages = []*api.Message{nested1, nested2}
...
func TestGenerateMessage_WithNestedEnum(t *testing.T) {
	...
	nestedEnum.WithUniqueNumberValues(nestedEnum.Values...)
...
func TestGenerateMessage_WithExternalImports(t *testing.T) {
	...
	model := api.NewTestAPI([]*api.Message{message, externalMessage}, nil, nil)
	model.PackageName = "google.cloud.test.v1"
...
func TestGenerateMessage_DocComments(t *testing.T) {
	...
	nested := api.NewTestMessage("NestedMessage").
		WithPackage("google.cloud.test.v1").
		WithID(".google.cloud.test.v1.TestMessage.NestedMessage")
	nested.Documentation = "Documentation for NestedMessage."

	msg := api.NewTestMessage("TestMessage").
		WithPackage("google.cloud.test.v1")
	msg.Documentation = "Documentation for TestMessage."
	msg.Messages = []*api.Message{nested}
