...
func TestFieldTypeName_BaseMessage(t *testing.T) {
	...
	nested.Parent = outer
	outer.Messages = []*api.Message{nested}
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			field: api.NewTestField("field1").
				...
				WithTypezID(".google.cloud.test.v1.SimpleMessage"),
			want: "SimpleMessage",
		},
		{
			name: "nested message",
			field: api.NewTestField("field2").
				WithType(api.TypezMessage).
				WithTypezID(".google.cloud.test.v1.OuterMessage.NestedMessage"),
...
func TestFieldTypeName_BaseEnum(t *testing.T) {
	...
	nested := api.NewTestEnum("NestedEnum").
		WithPackage("google.cloud.test.v1").
		WithID(".google.cloud.test.v1.OuterMessage.NestedEnum")
	nested.Parent = outer
	outer.Enums = []*api.Enum{nested}
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			field: api.NewTestField("field1").
				...
				WithTypezID(".google.cloud.test.v1.SimpleEnum"),
			want: "SimpleEnum",
		},
		{
			name: "nested enum",
			field: api.NewTestField("field2").
				WithType(api.TypezEnum).
				WithTypezID(".google.cloud.test.v1.OuterMessage.NestedEnum"),
...
func TestFieldTypeName_Map(t *testing.T) {
	...
	field := api.NewTestField("field1").
		WithType(api.TypezMessage).
		WithTypezID(".google.cloud.test.v1.WithMap.SingularMapEntry")
...
func TestFieldTypeName_ExternalNestedMessage(t *testing.T) {
	...
	externalNested.Parent = externalOuter
